  ...
  return (
    <motion.div
      ...
      className={`relative p-8 rounded-3xl transition-all duration-300 cursor-pointer ${
        isSelected
          ? "bg-gradient-to-br from-teal-500/20 to-emerald-500/20 border-2 border-teal-400/50 shadow-lg shadow-teal-400/10"
    ...
    >
      <div className="space-y-6">
        <div className="flex justify-center">
          <div className="p-4 rounded-xl bg-gradient-to-br from-teal-500 to-emerald-600 shadow-md">
            {icon}
          </div>
        </div>
...
const CarbonMarketServices = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-green-900 via-green-800 to-green-900 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0 bg-[url('/pattern-grid.svg')]"></div>
      </div>
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-green-700 to-green-400"></div>
      ...
      <div className="container mx-auto px-5 max-w-7xl relative z-10">
        ...
        >
          <span className="inline-block px-4 py-2 rounded-full bg-teal-400/10 text-teal-300 text-sm font-medium mb-6">
        ...
        <AnimatePresence>
          {selectedService && (
            ...
            >
              <button className="bg-gradient-to-r from-teal-400 to-emerald-500 hover:from-teal-300 hover:to-emerald-400 text-gray-900 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-teal-400/30">
