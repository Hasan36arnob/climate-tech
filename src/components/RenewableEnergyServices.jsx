    ...
    >
      <div className="space-y-6">
        <div className="flex justify-center">
          <div className="p-4 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 shadow-md">
            {icon}
          </div>
        </div>
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-green-800 via-green-700 to-green-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 max-w-7xl relative z-10">
        ...
        >
          <span className="inline-block px-4 py-2 rounded-full bg-emerald-400/10 text-emerald-300 text-sm font-medium mb-6">
