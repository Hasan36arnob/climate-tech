...
const InnovationServices = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-green-800 via-green-700 to-green-800 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0 bg-[url('/pattern-grid.svg')]"></div>
      </div>
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-white-400 to-white-500"></div>
      ...
      <div className="container mx-auto px-5 max-w-7xl relative z-10">
        ...
        >
          <span className="inline-block px-4 py-2 rounded-full bg-blue-400/10 text-blue-300 text-sm font-medium mb-6">
            Digital Transformation
          </span>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Driving <span className="text-blue-400">IT Innovation</span>
          </h2>
        ...
        <AnimatePresence>
          {selectedService && (
            ...
            >
              <button className="bg-gradient-to-r from-blue-400 to-indigo-500 hover:from-blue-300 hover:to-indigo-400 text-gray-900 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-blue-400/30">
