  ...
  return (
    <motion.div
      ...
      className={`relative p-8 rounded-3xl transition-all duration-300 cursor-pointer ${
        isSelected
          ? "bg-gradient-to-br from-cyan-500/20 to-emerald-500/20 border-2 border-cyan-400/50 shadow-lg shadow-cyan-400/10"
    ...
    >
      <div className="space-y-6">
        <div className="flex justify-center">
          <div className="p-4 rounded-xl bg-gradient-to-br from-cyan-500 to-emerald-600 shadow-md">
            {icon}
          </div>
        </div>
      ...
      {isSelected && (
        <div className="absolute -top-3 -right-3 bg-cyan-400 text-cyan-900 p-2 rounded-full shadow-md">
...
const ClimateFinanceServices = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-green-900 via-green-700 to-green-900 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-5 max-w-7xl relative z-10">
        ...
        >
          <span className="inline-block px-4 py-2 rounded-full bg-cyan-400/10 text-cyan-300 text-sm font-medium mb-6">
            Sustainable Investing
          </span>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Leveraging <span className="text-cyan-400">Climate Finances</span>
          </h2>
        ...
        <AnimatePresence>
          {selectedService && (
            ...
            >
              <button className="bg-gradient-to-r from-cyan-400 to-emerald-500 hover:from-cyan-300 hover:to-emerald-400 text-gray-900 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-cyan-400/30">
