  ...
  return (
    <motion.div
      ...
      className={`bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 
        border ${isSelected ? "border-green-400" : "border-green-400/20"}`}
      ...
      <div className="relative">
        {isSelected && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="absolute -top-2 -right-2 bg-green-400 text-green-900 p-2 rounded-full"
          >
        ...
        <p className="text-green-100/80 mb-6">{service.description}</p>

        <motion.ul
          className="space-y-3 text-green-100/90"
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        >
          <span className="inline-block px-4 py-2 rounded-full bg-green-400/10 text-green-300 text-sm font-semibold mb-6 ring-1 ring-green-400/20">
        ...
        <AnimatePresence>
          {selectedServices.size > 0 && (
            <motion.div
              ...
              exit={{ opacity: 0, y: 20 }}
              className="mt-12 p-8 bg-white/5 backdrop-blur-lg rounded-2xl border border-green-400/20"
            >
              ...
              <button
                className="bg-green-400 hover:bg-green-300 text-green-900 px-8 py-4 rounded-full font-semibold transition duration-300 shadow-lg transform hover:scale-105 hover:shadow-green-400/25"
        ...
        >
          ...
          <button className="group relative px-8 py-4 bg-transparent border-2 border-green-400 text-green-400 rounded-full font-semibold transition duration-300 hover:bg-green-400 hover:text-green-900">
