...
const GreenSolutionsHero = () => {
  ...
  return (
    <div className="relative min-h-screen">
      {/* Navbar */}
      <nav
        className={`fixed w-full z-50 bg-green-700 shadow-lg transition-all duration-300 ${
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              {navLinks.map((link) => (
                <a
                  ...
                  className="block px-3 py-2 text-white/90 hover:text-white hover:bg-green-600/50 rounded-md transition-colors duration-300"
                >
                  {link.name}
                </a>
              ))}
      ...
      {/* Hero Section */}
      <div className="relative h-screen flex items-center justify-center bg-gradient-to-br from-green-900 to-emerald-800 overflow-hidden">
