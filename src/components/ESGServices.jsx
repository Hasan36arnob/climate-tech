  ...
  return (
    <motion.div
      ...
      className={`relative p-8 rounded-3xl transition-all duration-300 cursor-pointer ${
        isSelected
          ? "bg-gradient-to-br from-teal-500/20 to-blue-500/20 border-2 border-teal-400/50 shadow-lg shadow-teal-400/10"
    ...
    >
      <div className="space-y-6">
        <div className="flex justify-center">
          <div className="p-4 rounded-xl bg-gradient-to-br from-teal-500 to-gray-600 shadow-md">
            {icon}
          </div>
        </div>
      ...
      <div className="container mx-auto px-5 max-w-7xl relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Comprehensive <span className="text-teal-400">ESG Services</span>
          </h2>
        ...
        <AnimatePresence>
          {selectedService && (
            ...
            >
              <button className="bg-gradient-to-r from-teal-400 to-blue-500 hover:from-teal-300 hover:to-blue-400 text-gray-900 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-teal-400/30">
                Learn About Our{" "}
