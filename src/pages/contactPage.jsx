...
const ContactPage = () => {
  ...
  return (
    <section
      id="contact"
      className="relative py-24 bg-gradient-to-br from-green-50 to-green-100"
    >
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="text-center mb-16">
          <span className="inline-block px-4 py-2 rounded-full bg-green-100 text-green-700 text-sm font-semibold mb-6">
            Get In Touch
          </span>
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-green-900">
            Contact Our
            <span className="text-green-600 block mt-2">Climate Tech Team</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full px-4 py-3 rounded-lg border border-green-200 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all placeholder-green-400/60"
                  ...
                  <div>
                    ...
                    <select
                      id="service"
                      name="service"
                      className="w-full px-4 py-3 rounded-lg border border-green-200 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all text-green-800 bg-white"
                    >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5 }}
            className="bg-green-800 rounded-2xl shadow-xl overflow-hidden text-white"
          >
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-green-100">+8801716415528</p>
